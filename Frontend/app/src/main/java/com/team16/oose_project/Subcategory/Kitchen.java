        ...
        bottomBar.setOnTabSelectListener(new OnTabSelectListener() {
            ...
            public void onTabSelected(@IdRes int tabId) {
                if(tabId == R.id.tab_me) {
                    ...
                    Intent myProfile = new Intent(Kitchen.this, MyAccountDisplay.class);
                    startActivity(myProfile);
                    System.out.println("***********Me tab selected");
                }

                if(tabId == R.id.tab_selling){
                    Intent sellingList = new Intent(Kitchen.this,
                ...
                if(tabId == R.id.tab_post){
                    Intent post = new Intent(Kitchen.this,
                ...
                if(tabId == R.id.tab_home){
                    Intent guestHomePage = new Intent(Kitchen.this, GuestHomePage.class);
                    startActivity(guestHomePage);
                    System.out.println("*********** Home tab selected");
                }

                if(tabId == R.id.tab_wishes){
                    Intent wishList = new Intent(Kitchen.this, WishList.class);
