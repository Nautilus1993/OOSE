...
/**
* Activity in wich the user enters the phone registration code.
* @author  Team 16
*/
public class PhoneCodeVerification extends AppCompatActivity implements CodeValidation{
    ...
    // If the codes matchm go to the next activity. Otherwise, display an error message.
    ...
    // Test to see if the code entered mathces the code generated by the server.
    @Override
