...
public class ItemPhotoController {
    ...
    /**
     * ItemPhotoController setendpoint:
     *
     * Endpoint 1 : POST ("/itemimage/upload/:userId") --> user post a new item
     * Endpoint 2 : GET ("/itemimage/display/:itemId") --> display item detail
     */
    private void setupEndpoints(){
        ...
        // Todo: display list of item photo
